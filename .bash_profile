...
alias maple='ssh -x -v -Y $USERNAME@maple.mcsr.olemiss.edu'
alias sequoia='ssh -x -v -Y $USERNAME@sequoia.mcsr.olemiss.edu'
alias catalpa='ssh -x -v -Y $USERNAME@catalpa.mcsr.olemiss.edu'
